...
let set_close_on_exec _file_descr = ()
let fork () = node_process_pid
let dup2 _fd1 _fd2 = ()
let execvpe _command _args _env = node_process_pid
let in_channel_of_descr _fd = Pervasives.stdin
let out_channel_of_descr _fd = Pervasives.stdout
let mkfifo _name _perm = ()
